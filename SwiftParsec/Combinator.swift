...
/**
    ...
    returned by `p`.
        ...
        func priority<a, c: Collection> () -> Parser<a, c>.T {
          return option(0, { state in
            digit() >>- { d in
              create(Int(d))
            }
          })
...
/**
    ...
    Returns the value returned by `p`.
        ...
        func braces<a, c: Collection> (_ p: Parser<a, c>.T) -> Parser<a, c>.T {
...
/**
    ...
    array of the returned values of `p`.
        ...
        func word<a, c: Collection> () -> Parser<[a], c>.T {
          return many1(letter())
        }
*/
...
/**
    ...
    by `sep`. Returns a list of values returned by `p`.
        ...
        func commaSep<a, c: Collection> (_ p: Parser<a, c>.T) -> Parser<[a], c>.T {
          return sepBy(p, symbol(","))
        }
*/
...
/**
    ...
    statements. Returns a list of values returned by `p`.
        ...
        let haskellStatements = sepEndBy(haskellStatement, semi())
*/
...
/**
    ...
    recursion which typically occurs in expression grammars.
        ...
        func expr<c: Collection> () -> Parser<Int, c>.T {
          return chainl1(term(), addop())
        }
        func term<c: Collection> () -> Parser<Int, c>.T {
          return chainl1(factor(), mulop())
        }
        func factor<c: Collection> () -> Parser<Int, c>.T {
...
public func anyToken<c: Collection where c.SubSequence == c> () -> Parser<c.Iterator.Element, c>.T {
  // TODO: nextPosition function seems incorrect
